...
public class coloans extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_coloans, container, false);
        ...
        mD2.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                mLoansgiven.setText(String.valueOf(dataSnapshot.getChildrenCount())+" Loans");
            }
        ...
        mD4.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                mArreas.setText(String.valueOf(dataSnapshot.getChildrenCount())+" Loans");
            }
