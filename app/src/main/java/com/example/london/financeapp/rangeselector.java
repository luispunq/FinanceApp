...
public class rangeselector extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(rangeselector.this, date1, myCalendar
        ...
        mEnd.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                new DatePickerDialog(rangeselector.this, date, myCalendar
                        .get(Calendar.YEAR), myCalendar.get(Calendar.MONTH),
                        myCalendar.get(Calendar.DAY_OF_MONTH)).show();
            }
        });
        ...
        mBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent back=new Intent(rangeselector.this,loananalysis.class);
                Bundle extras = new Bundle();
                Log.e("start-end",startd+"-"+endd);
