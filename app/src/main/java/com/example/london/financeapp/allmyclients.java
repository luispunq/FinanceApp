...
public class allmyclients extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(allmyclients.this);
            ...
            protected void populateViewHolder(final clientstodayHolder viewHolder, final activeclients model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent next =new Intent(allmyclients.this,memberprofile.class);
