...
public class loanappsadapter3 extends FirebaseRecyclerAdapter<loanapps,loanappsholder> {

    private Context context;


    loanappsadapter3(Class<loanapps> modelClass, int modelLayout, Class<loanappsholder> viewHolderClass, DatabaseReference ref, Context context) {
        ...
        if (model.getStatus().equals("pending")){
            ...
            viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent userwindow = new Intent(context,loanprocessingco.class);
